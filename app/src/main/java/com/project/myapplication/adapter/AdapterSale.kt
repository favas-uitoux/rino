...
class AdapterSale(private val context: Context, private val list: MutableList<modelReport>) :
    RecyclerView.Adapter<AdapterSale.VHClass>() {
...
//        if(cpr.type==0)
//        {
        holder.txtTotBuyQty.setText("Sell Qty: " + cpr.totSellQty.toString())
        holder.txtBuyAvg.setText("Avg: " + cpr.sellAvg.toString())
